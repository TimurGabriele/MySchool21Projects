...
// initial install for start tests
...
Suite *test_suite_create_matrix() {
...
Suite *test_suite_remove_matrix() {
...
int main() {
  int fail = 0;
  Suite *s[] = {test_suite_create_matrix(), test_suite_remove_matrix(),
