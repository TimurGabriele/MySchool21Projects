...
//     // -3961408126635554083362675097
//     s21_decimal decimal_check = {{0x99999999, 0xD9999999, 0xCCCCCCC,
//     0x80000000}};
...
//     // -3961408125713216879891945881
//     s21_decimal decimal_check = {{0xD9999999, 0xCCCCCCCC, 0xCCCCCCC,
//     0x80000000}};
...
//     // -3961408125713216879677197516
//     s21_decimal decimal_check = {{0xCCCCCCCC, 0xCCCCCCCC, 0xCCCCCCC,
//     0x80000000}};
...
//     // -15606476756221269529696665
//     s21_decimal decimal_check = {{0x99999999, 0xCCD9B599, 0xCE8CC,
//     0x80000000}};
...
//     // -15606476752587603503068569
//     s21_decimal decimal_check = {{0xCCD9B599, 0xCCCCCCCC, 0xCE8CC,
//     0x80000000}};
...
//     // -15606476752587603502222540
//     s21_decimal decimal_check = {{0xCCCCCCCC, 0xCCCCCCCC, 0xCE8CC,
//     0x80000000}};
...
//     // -7922816249581759352412936601
//     s21_decimal decimal_check = {{0x19999999, 0x80000000, 0x19999999,
//     0x80000000}};
...
//     // -75354719223747528150736506502
//     s21_decimal decimal_check = {{0x29BD0E86, 0x789AE890, 0xF37BF67A,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0xC8411C17, 0x52580535, 0x28A62,
//     0x80000000}};
...
//     // -24776303122033447770816286
//     s21_decimal decimal_check = {{0x3D747F1E, 0x1563C17B, 0x147E96,
//     0x80000000}};
...
//     // -16081854264805611805207457
//     s21_decimal decimal_check = {{0xF265EBA1, 0x110B0D12, 0xD4D77,
//     0x80000000}};
...
//     // -9808310768275773633671140903
//     s21_decimal decimal_check = {{0xB3231627, 0x2B3B9762, 0x1FB13E98,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x6916C1E1, 0xF15ECB7, 0xA4EE70,
//     0x80000000}};
...
//     // -24926833321041066052322067
//     s21_decimal decimal_check = {{0x17808313, 0x578CD7BC, 0x149E76,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x4480577F, 0xAE4E0035, 0x3DB4CB,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0xE4D86AAB, 0x55418D89, 0x634414D,
//     0x80000000}};
...
//     // -6288177403562580986674
//     s21_decimal decimal_check = {{0x31C74B32, 0xE1FDE059, 0x154,
//     0x80000000}};
...
//     // -2619179011288566074118613
//     s21_decimal decimal_check = {{0xB4AB11D5, 0xFA8CA1CE, 0x22AA1,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x8D2BBC48, 0x3482D862, 0xA6B,
//     0x80000000}};
...
//     // -807850117980773387502851
//     s21_decimal decimal_check = {{0xFC7E8503, 0xA4849225, 0xAB11,
//     0x80000000}};
...
//     // -13075303383249419419197
//     s21_decimal decimal_check = {{0x94DEBE3D, 0xD0492F23, 0x2C4,
//     0x80000000}};
...
//     // -5335647229141514076083373419
//     s21_decimal decimal_check = {{0x57EC56B, 0xDF610C3E, 0x113D8B3F,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x31C1BC5C, 0x5BEF3029, 0x175,
//     0x80000000}};
...
//     // -581040608149733468071159010
//     s21_decimal decimal_check = {{0x7ADE64E2, 0x7BA01EB2, 0x1E0A022,
//     0x80000000}};
...
//     // -6650079295467296275893
//     s21_decimal decimal_check = {{0xEC263DB5, 0x8063AD98, 0x168,
//     0x80000000}};
...
//     // -3876998283126537628464742
//     s21_decimal decimal_check = {{0x3C2CB666, 0x7F812653, 0x334FC,
//     0x80000000}};
...
//     // -7399558963281379318747941834
//     s21_decimal decimal_check = {{0x1A08CBCA, 0x2BD49C22, 0x17E8C58F,
//     0x80000000}};
...
//     // -7241693877823998707461377
//     s21_decimal decimal_check = {{0xBF996D01, 0x3016E60, 0x5FD7D,
//     0x80000000}};
...
//     // -340092298838133065713413431
//     s21_decimal decimal_check = {{0xD8436D37, 0x7658F16B, 0x1195158,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x52A15455, 0x3B025E36, 0x560F6,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0xCC44891, 0x77D38EBB, 0x3317D,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x537CC876, 0x7446AC27, 0x323AC7C,
//     0x80000000}};
...
//     // -239291059607740827681383951
//     s21_decimal decimal_check = {{0x85F660F, 0x558B163D, 0xC5EFDA,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x10AD15EE, 0x81B14171, 0x1A3,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x14D3A82A, 0x7B329898, 0x199,
//     0x80000000}};
...
//     // -61806780207463409555865382696
//     s21_decimal decimal_check = {{0x23CAF28, 0xC367515C, 0xC7B55ECC,
//     0x80000000}};
...
//     // -69183197916081615266045
//     s21_decimal decimal_check = {{0x559FE0FD, 0x6DBD9462, 0xEA6,
//     0x80000000}};
...
//     // -76328328034632120992739
//     s21_decimal decimal_check = {{0x193903E3, 0xC45716AF, 0x1029,
//     0x80000000}};
...
//     // -6480372573928216122405764989
//     s21_decimal decimal_check = {{0xB61D3F7D, 0x288E6245, 0x14F07045,
//     0x80000000}};
...
//     // -3199202773272639757482094925
//     s21_decimal decimal_check = {{0x3292714D, 0xD9A63473, 0xA565189,
//     0x80000000}};
...
//     // -4448910377678692130752120666
//     s21_decimal decimal_check = {{0xE459475A, 0xD56897A1, 0xE600D6A,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x536F0BC9, 0x8965C01D, 0x3AFF77E,
//     0x80000000}};
...
//     // -71421535667212420368501785
//     s21_decimal decimal_check = {{0xDFE70C19, 0x34E5D7EA, 0x3B1419,
//     0x80000000}};
...
//     // -45894075307089895587689075894
//     s21_decimal decimal_check = {{0x86E114B6, 0x9BA69286, 0x944AB077,
//     0x80000000}};
...
//     // -11549041300792984442846624
//     s21_decimal decimal_check = {{0x53C93DA0, 0xC88E5BF2, 0x98D9A,
//     0x80000000}};
...
//     // -3868178560416445951548906324
//     s21_decimal decimal_check = {{0x8438DB54, 0xF0325662, 0xC7FAEAB,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x2AE8BEDE, 0x5DA29646, 0x13BB2814,
//     0x80000000}};
...
//     // -1005349422549639641243141
//     s21_decimal decimal_check = {{0xC03D1E05, 0x19F5775E, 0xD4E4,
//     0x80000000}};
...
//     // -70557390526677147131472
//     s21_decimal decimal_check = {{0xAEFF1E50, 0xEC7E76EF, 0xEF0,
//     0x80000000}};
...
//     // -452402542153273821354364046
//     s21_decimal decimal_check = {{0xBC298C8E, 0xF3B80E5E, 0x17637F6,
//     0x80000000}};
...
//     // -42285747225241820622276182653
//     s21_decimal decimal_check = {{0x2AE6C27D, 0x56C8F164, 0x88A1F346,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x635DE40D, 0xEA8F55C7, 0xA21,
//     0x80000000}};
...
//     // -13981151453979215016714553
//     s21_decimal decimal_check = {{0xDA976139, 0xBD2FEEF7, 0xB909F,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x568BDEEA, 0x899BDB76, 0xD49B39D,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x3FBE46F, 0x12EB49DD, 0x2307,
//     0x80000000}};
...
//     // -75389544484508693574716540007
//     s21_decimal decimal_check = {{0x9690C467, 0xA3CCE52B, 0xF398C503,
//     0x80000000}};
...
//     // -7033970046697049902273
//     s21_decimal decimal_check = {{0x83774CC1, 0x4FF199E6, 0x17D,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x4D2B108C, 0x126702F6, 0x34D,
//     0x80000000}};
...
//     // -326102205602944283462484921
//     s21_decimal decimal_check = {{0x5FF643B9, 0xFD0497F0, 0x10DBED3,
//     0x80000000}};
...
//     s21_decimal decimal_check = {{0x65B74B45, 0xAA03A1D2, 0xE1526,
//     0x80000000}};
